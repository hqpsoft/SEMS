using System;
namespace SEMS.Infrastructure.Logging
{
    /// <summary>
    ...
    public abstract class LogBase : ILog
    {
        ...
        protected abstract void Write(LogLevel level, object message, System.Exception exception);
        ...
        public virtual void Error<T>(T message, System.Exception exception)
        {
            if (IsErrorEnabled)
            {
        ...
        /// <param name="exception">异常</param>
        /// <param name="args">格式化参数</param>
        public virtual void Error(string format, System.Exception exception, params object[] args)
        {
            if (IsErrorEnabled)
            {
        ...
        /// <param name="message">日志消息</param>
        /// <param name="exception">异常</param>
        public virtual void Fatal<T>(T message, System.Exception exception)
        {
            if (IsFatalEnabled)
            {
        ...
        /// <param name="exception">异常</param>
        /// <param name="args">格式化参数</param>
        public virtual void Fatal(string format, System.Exception exception, params object[] args)
        {
            if (IsFatalEnabled)
            {
