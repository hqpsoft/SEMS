...
namespace SEMS.Infrastructure.Logging
{
    ...
    internal sealed class Logger : ILogger
    {
        ...
        {
            EntryLevel = ConfigurationManager.AppSettings.Get("SEMS-EntryLogLevel").CastTo(LogLevel.All);
        ...
        /// <param name="exception">异常</param>
        /// <param name="args">格式化参数</param>
        public void Error(string format, System.Exception exception, params object[] args)
        {
            if (!IsEnabledFor(LogLevel.Error))
            {
                return;
        ...
        /// <param name="message">日志消息</param>
        /// <param name="exception">异常</param>
        public void Fatal<T>(T message, System.Exception exception)
        {
            if (!IsEnabledFor(LogLevel.Fatal))
            {
                return;
        ...
        /// <param name="exception">异常</param>
        /// <param name="args">格式化参数</param>
        public void Fatal(string format, System.Exception exception, params object[] args)
        {
            if (!IsEnabledFor(LogLevel.Fatal))
            {
                return;
