...
namespace SEMS.Infrastructure.Logging
{
    ...
    public interface ILogger
    {
        ...
        void Error<T>(T message, System.Exception exception);
        ...
        /// <param name="exception">异常</param>
        /// <param name="args">格式化参数</param>
        void Error(string format, System.Exception exception, params object[] args);
        ...
        /// <param name="message">日志消息</param>
        /// <param name="exception">异常</param>
        void Fatal<T>(T message, System.Exception exception);
        ...
        /// <param name="exception">异常</param>
        /// <param name="args">格式化参数</param>
        void Fatal(string format, System.Exception exception, params object[] args);
